ServerEvents.recipes((e) => {
  ...
  remove_recipes_id(e, ['createsolar:sculk_panel', 'createsolar:growth_lamp']);

  e.replaceInput(
    { id: 'createsolar:solar_panel' },
  ...
  kubejs
    .shaped('createsolar:sculk_panel', ['BAB', 'DCD', 'FEF'], {
    ...
    .id('createdelightcore:sculk_panel');
});
