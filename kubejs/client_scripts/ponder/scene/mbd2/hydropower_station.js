Ponder.registry((event) => {
  ...
  event
    .create([
      ...
      'createdelightcore:dragon_steel_fan',
    ])
    .scene(
      'createdelightcore:hydropower_station',
      '大坝！水利工程的巅峰之作！',
      ...
      (builder, util) => {
        ...
        // [ponder-camera] 按结构尺寸适配（16x15x16，参考 Create 的 configureBasePlate/scaleSceneView/setSceneOffsetY 用法）
        ...
        scene
          .text(
            140,
            '当然, 大坝也支持横向拓展, 最少1个转子, 最多13个转子, 且每个转子均可单独输出应力'
          )
          .attachKeyFrame();
