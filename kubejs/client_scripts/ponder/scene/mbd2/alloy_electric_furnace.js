Ponder.registry((e) => {
  e.create(['createdelightcore:alloy_electric_furnace', 'createdelightcore:copper_coil'])
    .scene(
      ...
      (builder, util) => {
        ...
        scene
          .text(
            40,
            '在这个多方块结构中, 任意的锻造钢机壳都可以被锻造钢输入/输出总线代替',
            [2, 2.5, 4.5]
          )
          .attachKeyFrame();
    ...
    .scene(
      'createdelightcore:using_alloy_electric_furnace',
      '合金电炉的使用',
      ...
      (builder, util) => {
        ...
        let coke = scene.world.createItemEntity([8.5, 4, 5.5], [0, 0, 0], 'createmetallurgy:coke');
        scene.idle(10);
        ...
        scene.world.createItemEntity([1.5, 2.3, 4.5], [0, 0, 0], '3x createmetallurgy:steel_ingot');
