Ponder.registry((event) => {
  event
    .create(['createdelightcore:big_centrifuge', 'createdelightcore:centrifuge_rotor'])
    .scene(
      ...
      (builder, util) => {
        ...
        scene
          .text(
            40,
            '在这个多方块结构中, 任意的钢制机壳都可以被钢制输入/输出总线代替',
            [2, 3.5, 4.5]
          )
          .attachKeyFrame();
        ...
        scene.world.replaceBlocks(
          [3, 3, 2, 5, 6, 2],
          Block.id('createdelightcore:steel_glass_casing').blockState,
          true
        );
        scene.world.replaceBlocks(
          [2, 4, 3, 2, 5, 5],
          Block.id('createdelightcore:steel_casing').blockState,
          true
        );
        scene.world.replaceBlocks(
          [2, 3, 3],
        ...
        scene.world.replaceBlocks(
          [3, 3, 2, 5, 6, 2],
          Block.id('createdelightcore:steel_clear_glass_casing').blockState,
          false
        );
        scene.world.replaceBlocks(
          [2, 4, 3, 2, 5, 5],
        ...
        scene.text(
          140,
          '其中离心机转子可以叠加, 最少一层, 最多三层, 每层离心机转子使得配方速度*4, 且可与转速叠加',
          [4.5, 4.5, 4.5]
        );
        scene.idle(20);
    ...
    .scene(
      'createdelightcore:using_big_centrifuge',
      '大型离心机的使用',
      ...
      (builder, util) => {
        ...
        PonderUtil.createItemOnBelt(
          scene,
          [8, 1, 4],
          Direction.UP,
          Item.of('64x createmetallurgy:dirty_iron_dust')
        );
        scene.idle(20);
        ...
        scene.world.createItemEntity([1.5, 2.3, 4.5], [0, 0, 0], '64x createmetallurgy:iron_dust');
        scene.idle(20);
        PonderUtil.flapFunnel(scene, [1, 2, 4], true);
        scene.world.createItemEntity([1.5, 2.3, 4.5], [0, 0, 0], '16x createmetallurgy:iron_dust');
        scene.idle(20);
        PonderUtil.flapFunnel(scene, [1, 2, 4], true);
        scene.world.createItemEntity([1.5, 2.3, 4.5], [0, 0, 0], '48x minecraft:redstone');
        scene.idle(5);
