Ponder.registry((event) => {
  event
    .create('ae2:annihilation_plane')
    .scene(
      'createdelightcore:annihilation_plane',
      '破坏面板的使用',
      ...
      (builder, util) => {
        ...
        scene.idle(20);
        scene.showControls(40, [0.5, 2, 2.5], 'down').withItem('ae2:certus_quartz_crystal');
        scene.idle(60);
    ...
    .scene(
      'createdelightcore:annihilation_plane_filter',
      '使破坏面板破坏/收集特定的物品',
      ...
      (builder, util) => {
        ...
        scene
          .text(60, '你会发现破坏面板会收集它前方的所有物品……', [2.5, 2.5, 1.5])
          .attachKeyFrame();
        scene.idle(80);
        ...
        scene.idle(80);
        scene.showControls(40, [4.75, 1.5, 2.5], 'down').withItem('ae2:certus_quartz_crystal');
        scene.idle(40);
        let quartz_list = [
        ...
        scene.world.destroyBlock([2, 2, 1]);
        scene.showControls(40, [5.5, 2, 2.5], 'down').withItem('ae2:certus_quartz_crystal');
        scene.idle(60);
