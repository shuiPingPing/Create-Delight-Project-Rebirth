Ponder.registry((event) => {
  ...
  event
    .create(['ae2:fluix_glass_cable', 'ae2:fluix_covered_cable'])
    .scene(
      'createdelightcore:small_cable',
      '玻璃线缆与包层线缆',
  ...
  event.create('ae2:fluix_covered_dense_cable').scene(
    'createdelightcore:covered_dense_cable',
    '致密包层线缆',
