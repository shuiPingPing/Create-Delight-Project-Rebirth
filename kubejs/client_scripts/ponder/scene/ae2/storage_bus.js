Ponder.registry((event) => {
  event.create(['ae2:storage_bus']).scene(
    'createdelightcore:storage_bus',
    '存储总线的使用',
    'createdelightcore:ponder_storage_bus',
    ...
    (builder, util) => {
      ...
      scene.idle(40);
      scene.showControls(40, [2, 1.5, 2.75], 'right').withItem('ae2:certus_quartz_crystal');
    }
  );
  event.create(['ae2:storage_bus', 'ae2:interface', 'ae2:cable_interface']).scene(
    'createdelightcore:storage_bus_interface_interaction',
    '存储总线与ME接口的互动',
    'createdelightcore:ponder_storage_bus_interface_interaction',
    ...
    (builder, util) => {
      ...
      scene.idle(20);
      scene.showControls(60, [2.5, 1.5, 2.75], 'down').withItem('ae2:certus_quartz_crystal');
    }
  );
});
